...
// 5. Using cout and x (not p1), display the value of x.
    std::cout << "# 5:  x contains: " << x << std::endl;

// 6. Using cout and the pointer p1 (not x), display the value of x.
    std::cout << "# 6:  x contains: " << *p1 << std::endl;
...
// 17. Using cout and p2 only, display the address of the first element in a.
    std::cout << "#17:  The address of the first element is " << p2 << std::endl;
...
//     pointing to the first element of a.   Don't use pointer arithmetic.
    std::cout << "#18:  The address of the second element is " << &p2[1] << std::endl;
...
//     (The first element should be 99, the second 0).
    std::cout << "#20:  The first element in a[] is "
              << a[0]
              << " and the second element in a[] is "
              << a[1]
              << std::endl;
...
// Takes a single int pointer. Returns 0 if the number is negative. Returns the number
...
// Takes two integer pointers and swaps the values that those pointers point to
void swap(int* a, int* b) {
    int temp;
    temp = *a;
    *a = *b;
